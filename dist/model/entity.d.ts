...
export declare const Subject: Sequelize.Model<SubjectI, any>;
export declare const Student: Sequelize.Model<StudentI, any>;
export declare const Teacher: Sequelize.Model<TeacherI, any>;
export declare const Lecture: Sequelize.Model<LectureI, any>;
